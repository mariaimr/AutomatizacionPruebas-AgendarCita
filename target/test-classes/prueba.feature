Feature: Prueba para agendar una cita
  ...
  Scenario Outline: AgendarCita
    ...
    When El usuario ingrese el nombre del doctor "<nombreDoctor>", los apellidos "<apellidosDoctor>", el telefono "<telefono>", el tipo de documento "<tipoDocumento>" y el numero de identidad
    ...
    And El usuario ingrese el dia de la cita "<diaCita>", el documento de identidad del paciente, el documento de identidad del doctor y las observaciones "<observaciones>"
    ...
    Examples: 
      ...
      | Pedro        | Martinez Rendon |  5558000 | Cédula de ciudadanía | Carlos         | Martinez Rendon   |   5558000 | Pasaportes           | true           | Datos guardados correctamente. | 07/05/2018 | Cita para revisión general |
      |              | Sepulveda       |  4567834 | Cédula de ciudadanía |                | Sepulveda         |   4567834 | Cédula de ciudadanía |  false          | No se pudo guardar debido a:   | 07/28/2018 |                            |
